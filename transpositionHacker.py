# Transposition Cipher Crack Program
# BSD Licensed
...
def hackTransposition(message):
  ...
  print('(Press Ctrl-C (on Windows) or Ctrl-D (on Unix) to quit at any time.)')
  ...
  for key in range(1, len(message)):
    ...
    if detectEnglish.isEnglish(decryptedText):
      ...
      print()
      print('Enter D to continue decrypting with this key, or C to try another key.')
      response = input('> ')
